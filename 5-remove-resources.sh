...
FUNCTION=$(aws cloudformation describe-stack-resource --stack-name $STACK --logical-resource-id ScraperFunction --query 'StackResourceDetail.PhysicalResourceId' --output text)
...
rm -f out.yml out.json src/*.pyc
#rm -rf package src/__pycache__
